...
const { deleteQuery, getAllQuery, newQuery, updateQueryStatus, getQuery, clientNewQuery } = require("../controllers/queryController.js")
...
qureyRouters.post('/customer/query/new', clientNewQuery)
